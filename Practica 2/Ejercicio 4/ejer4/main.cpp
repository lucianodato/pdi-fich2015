...
int main(int argc, char *argv[])
{
        ...
        CImg<unsigned char> img_emboss(img.width()-corrimiento,img.height()-corrimiento,1,1);
        CImg<unsigned char> lut(generar_lut(-1,150,0,255)); // negativo:
        img_neg=transformacion(img,lut);	//aplico lut
